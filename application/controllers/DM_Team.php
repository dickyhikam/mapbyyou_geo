...
/**
 * Description of DM_Team
 *
 * @author dickyhikam
 */
class DM_Team extends CI_Controller
{
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                if ($status_access == 'found') {
                    ...
                    $this->load->view('data_master/team/index');
    ...
    public function table()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                $data = array();
                $list =  $this->Mglobals->getAllQ("SELECT * FROM tb_geolancer_team ORDER BY `name` ASC;");
    ...
    public function rowdata()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                $tampil = $this->Mglobals->getAllQR("SELECT * FROM tb_geolancer_team WHERE id = '" . $id . "';");
    ...
    public function add()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                $simpan = $this->Mglobals->add("tb_geolancer_team", $data);
                if ($simpan) {
                    $status = "success";
                } else {
                    $status = "failed";
    ...
    public function update()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                $condition['id'] = $id;
                $update = $this->Mglobals->update("tb_geolancer_team", $data, $condition);
                if ($update) {
                    $status = "success";
                } else {
                    $status = "failed";
    ...
    public function delete()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                //delete to database
                $condition['id'] = $id;
                $delete = $this->Mglobals->delete("tb_geolancer_team", $condition);
                if ($delete) {
                    $status = "success";
                } else {
                    $status = "failed";

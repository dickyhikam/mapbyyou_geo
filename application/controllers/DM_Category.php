...
/**
 * Description of DM_Category
 *
 * @author dickyhikam
 */
class DM_Category extends CI_Controller
{
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                if ($status_access == 'found') {
                    ...
                    $this->load->view('data_master/category/index');
    ...
    public function table()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                $data = array();
                $list = $this->DbMenu->AllMenu();
                foreach ($list->result() as $row) {
                    $val = array();

                    //get data menu
                    $data_menu = $this->DbMenu->RowMenu("*, COUNT(*) AS jml", "id = '" . $row->id_menu . "'");
    ...
    public function rowdata()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                $con['id'] = $id;
                $tampil = $this->DbMenu->RowMenu("*", $con);
    ...
    public function add()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                $simpan = $this->DbMenu->AddMenu($data);
                if ($simpan) {
                    $status = "success";
                } else {
                    $status = "failed";
    ...
    public function update()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                $condition['id'] = $id;
                $update = $this->DbMenu->UpdateMenu($data, $condition);
                if ($update) {
                    $status = "success";
                } else {
                    $status = "failed";
    ...
    public function delete()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                //delete to database
                $condition['id'] = $id;
                $delete = $this->DbMenu->DeleteMenu($condition);
                if ($delete) {
                    $status = "success";
                } else {
                    $status = "failed";

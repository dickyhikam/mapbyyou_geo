...
/**
 * Description of DM_Country
 *
 * @author dickyhikam
 */
class DM_Country extends CI_Controller
{
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                if ($status_access == 'found') {
                    ...
                    $this->load->view('data_master/country/index');
    ...
    public function table()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                $data = array();
                $list = $this->Mglobals->getAllQ("SELECT * FROM tb_geolancer_country ORDER BY `order` ASC;");
    ...
    public function rowdata()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                $tampil = $this->Mglobals->getAllQR("SELECT * FROM tb_geolancer_country WHERE id = '" . $id . "';");
    ...
    public function add()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                $simpan = $this->Mglobals->add("tb_geolancer_country", $data);
                if ($simpan) {
                    $status = "success";
                } else {
                    $status = "failed";
    ...
    public function update()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                $condition['id'] = $id;
                $update = $this->Mglobals->update("tb_geolancer_country", $data, $condition);
                if ($update) {
                    $status = "success";
                } else {
                    $status = "failed";
    ...
    public function delete()
    {
        ...
        if (isset($session_data)) {
            ...
            if ($login_status == 'succeed login') {
                ...
                //delete to database
                $condition['id'] = $id;
                $delete = $this->Mglobals->delete("tb_geolancer_country", $condition);
                if ($delete) {
                    $status = "success";
                } else {
                    $status = "failed";

    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group text-center">
                        <button class="btn btn-primary btn-block waves-effect waves-light" <?= $qc_btn ?> id="btn_login" onclick="edit('<?= $id_poi_edit ?>');">Start Edit <i class="fas fa-file-alt"></i></button>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function table() {
        ...
        $('#table').DataTable({
            ajax: "<?php echo base_url(); ?>QC_Result/show_table_poi/" + periode + "/" + id_qa + "/" + id_qc,
            columnDefs: [{
                targets: [4, 5, 6], // your case column
    ...
    function edit(id) {
        window.location = "<?php echo base_url(); ?>ResultQC/edit/" + id;
    }
</script>
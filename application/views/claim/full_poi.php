            ...
            <div class="col-sm-4">
                <div class="card-box">
                    ...
                    <form id="">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">Main Entrance</label>
                            <div class="col-9">
                                <input class="form-control" placeholder="Enter main entrance location" id="example-text-input" name="">
                            </div>
                        </div>
                        <div class=" form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">MOB</label>
                            <div class="col-9">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">PII Correct</label>
                            <div class="col-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select class="form-control" id="pii" name="pii" data-placeholder="Choose ...">
                                    ...
                                    <option value="The POI is duplicate.">The POI is duplicate.</option>
                                    <option value="The house number of the POI is not visible in the photo.">The house number of the POI is not visible in the photo.</option>
                                    <option value="There are no photos attached to this POI.">There are no photos attached to this POI.</option>
                                    ...
                                    <option value="The business name or logo is not clearly visible in the photo. It may be too dark, blurry, or blocked by object(s).">The business name or logo is not clearly visible in the photo. It may be too dark, blurry, or blocked by object(s).</option>
                                    ...
                                    <option value="The POI is not a permanent fixture (e.g. food truck, shops on wheels, food tent without opening hours). We are not collecting this type of POI.">The POI is not a permanent fixture (e.g. food truck, shops on wheels, food tent without opening hours). We are not collecting this type of POI.</option>
                                    ...
                                    <option value="The POI is too zoomed in as it was taken from a very close distance.">The POI is too zoomed in as it was taken from a very close distance.</option>
